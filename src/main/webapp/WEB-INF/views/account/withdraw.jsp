...
<body style="background-color: gray;">
	...
	<main class="form-signin">
		<form action="withdraw" method="post">
			<h1 class="h3 mb-3 fw-normal" style="text-align: center;">출금</h1>

			<div class="form-floating">
				<select name="sendAccountNum" class="form-control"
					style="padding-top: 0.8rem;">
					<option value="">출금 계좌번호</option>
			...
			<div class="form-floating">
				<input type="number" name="money" class="form-control"
					id="floatingPassword" placeholder="Password"> <label
					for="floatingPassword">출금액 </label>
			</div>
			<button class="w-100 btn btn-lg btn-primary" type="submit">출금</button>
		</form>
	</main>
