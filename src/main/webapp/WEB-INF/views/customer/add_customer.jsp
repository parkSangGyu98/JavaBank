...
<main class="form-signin">
  <form action="add_customer" method="post">
    ...
    <div class="form-floating">
      <input type="text" name="id" class="form-control" id="floatingPassword" placeholder="Password">
    ...
    <div class="form-floating">
      <input type="text" name="ssn" class="form-control" id="floatingPassword" placeholder="Password">
      <label for="floatingPassword">주민등록번호</label>
    </div>
    <div class="form-floating">
